    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerNav}>
            ...
            <ul className={styles.footerLinks}>
              ...
              <li><a href="#" className={styles.footerLink}>Risk Disclaimer</a></li>
          ...
          <div className={styles.footerNav}>
            ...
            <p className={styles.footerSubscriptionText}>Subscribe to our newsletter for the latest updates.</p>
            <div className={styles.subscriptionForm}>
              <input type="email" className={styles.subscriptionInput} placeholder="Your email" />
        ...
        <div className={styles.footerCopyright}>
          © {new Date().getFullYear()} YieldMax. All rights reserved.
        </div>
      </div>
    </footer>
  )
